...
////                .groupBy(Customer::getVehicle, sum(Customer::getDemandTotal))
...
//    
//    // ************************************************************************
//    // hard constraints mvcrp
//    // ************************************************************************
//    
//    protected Constraint cleaningAfterSwitch(ConstraintFactory factory) {
//		return factory.from(Product.class)
//				.penalizeLong("cleaningAfterSwitch",
//						HardSoftLongScore.ONE_HARD,
//						Product::getCleaningCost);
//	}
//    
//    // ************************************************************************
