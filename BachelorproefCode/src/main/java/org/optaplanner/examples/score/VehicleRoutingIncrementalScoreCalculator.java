...
//    private Map<Vehicle, List<Integer>> vehicleDemandMap;
//
...
//        	int compartiments = vehicle.getCompartiments();
//        	List<Integer> compartimentsDemand = new ArrayList<>();
//        	for(int y = 0; y < compartiments; y++) {
//        		compartimentsDemand.add(0);
//        	}
//            vehicleDemandMap.put(vehicle, compartimentsDemand);
//        }
//        hardScore = 0L;
//        softScore = 0L;
...
//            for(int y = 0; y < vehicle.getCompartiments(); y++) {
//            	capacityList.add(vehicle.getSpecificCompartimentCapacity(y));
//            }
//            List<Integer> oldDemand = vehicleDemandMap.get(vehicle);
//            List<Integer> newDemand = new ArrayList<>();
//            newDemand.add(oldDemand.get(0) + customer.getDemandTotal());
//            hardScore += Math.min(capacityList.get(0) - newDemand.get(0), 0) - Math.min(capacityList.get(0) - oldDemand.get(0), 0);
...
//        if (vehicle != null) {
//            // Score constraint vehicleCapacity
//            List<Compartiment> capacity = vehicle.getCompartimentsList();
//            List<Integer> oldDemand = new ArrayList<>();
//            oldDemand = vehicleDemandMap.get(vehicle);
//            List<Integer> newDemand = new ArrayList<>();
//            newDemand.add(oldDemand.get(0) - customer.getDemandTotal());
//            hardScore += Math.min(capacity.get(0).getCapacity() - newDemand.get(0), 0) - 
//            		Math.min(capacity.get(0).getCapacity() - oldDemand.get(0), 0);
//            
//            vehicleDemandMap.put(vehicle, newDemand);
//            if (customer.getNextCustomer() == null) {
//                // Score constraint distanceFromLastCustomerToDepot
